...
export class VehiclesComponent {
    ...
    manufacture() {
        this.vehicles = this.vehicles.filter((vehicle: any) => vehicle.manufacturer.includes(this.term1));
    }

    fuel() {
        this.vehicles = this.vehicles.filter((vehicle: any) => vehicle.fuel.includes(this.term2));
    }
